...
import { escapeHTML, getSystemHealthStatus } from './security.js';
import { refreshIcons } from './iconSystem.js';
import { createToastManager, createModalManager } from './modules/ui.js';
import { createThemeManager } from './modules/themeManager.js';
import { createLocalEncryptor } from './modules/encryption.js';
import { createNotificationManager } from './modules/notificationManager.js';
import { createNavigationManager } from './modules/navigationManager.js';
import { createCommandPalette } from './modules/commandPalette.js';
import { createGeminiService } from './modules/geminiService.js';
import { createOllamaService } from './modules/ollamaService.js';
import { createDataStore } from './data-store.js';
import { createJournalStore, createJournalModule } from './modules/journalModule.js';
import { createHomeModule } from './modules/homeModule.js';
import { createManualAnalyzer } from './modules/manualAnalyzer.js';
import { createQuickAnalyzer } from './modules/quickAnalyzer.js';
import { createAIModule } from './modules/aiModule.js';
import { createDojoSimulator } from './modules/dojoSimulator.js';
import { createGuideModule } from './modules/guideModule.js';
import { initializeFooterEnhancements } from './modules/footerEnhancements.js';
...
const quickAnalyzeBtn = document.querySelector('.quick-action-btn') || document.getElementById('quick-analyze');
if (quickAnalyzeBtn) {
...
// Initialize footer enhancements (theme/settings buttons)
